...
var vueApp = new Vue({
    ...
    data: {
        ...
        modelMtgaDecksPeriod: 'currentset',
        ...
        modelDraftsCalculator: {
            sets: ["", "ONE", "BRO", "DMU", "HBG", "SNC", "NEO", "VOW", "MID", "AFR", "STX", "KHM", "ZNR", "M21", "IKO", "THB", "ELD", "M20", "WAR", "RNA", "GRN", "M19", "DOM", "RIX", "XLN", "AKR", "KLR"],
            setSelected: "",
        ...
        modelUserCollectionFiltered: {
            ...
            filters: {
                ...
                sets: ['', "ONE", "YBRO", "BRO", "DMU", "YDMU", "HBG", "YSNC", "SNC", 'YNEO', "NEO", 'YMID', "VOW", "MID", "AFR", "STX", "STA", 'KHM', "KLR", 'ZNR', 'AKR', 'JMP', 'M21', 'IKO', 'THB', 'ELD', 'M20', 'WAR', 'RNA', 'GRN', 'M19', 'DOM', 'RIX', 'XLN'],
        ...
        modelStatsLimitedPeriod: 'currentset',
        ...
        modelDashboard: {
            ...
            detailsFilters: {
                sets: ['', "ONE", "BRO", "DMU", "HBG", "SNC", "NEO", 'VOW', "MID", "AFR", "STX", "STA", 'KHM', 'ZNR', 'M21', 'JMP', 'IKO', 'THB', 'ELD', 'M20', 'WAR', 'RNA', 'GRN', 'M19', 'DOM', 'RIX', 'XLN', 'AKR', "KLR", 'YMID', 'YNEO'],
        ...
        modelCustomDraftRatingsFilterSet: 'DMU',
    ...
    methods: {
        ...
        formatSetToFullName(set) {
            switch (set) {
                ...
                case 'YMID':
                    return 'Alchemy: Innistrad';
                case 'NEO':
                    return 'Kamigawa: Neon Dynasty';
                case 'YNEO':
                    return 'Alchemy: Kamigawa';
                case 'SNC':
                    return 'Streets of New Capenna';
                case 'HBG':
                    return 'Alchemy Horizons: Baldur\'s Gate';
                case 'DMU':
        ...
        refreshStatsLimited() {
            ...
            sendAjaxGet(`/api/User/statsLimited?period=${this.modelStatsLimitedPeriod}`, (statuscode, body) => {
        ...
        refreshMtgaDeckSummary() {
            ...
            sendAjaxGet('/api/User/MtgaDeckSummary?period=' + this.modelMtgaDecksPeriod, (statuscode, body) => {
        ...
        getMtgaDeck(mtgaDeckSummary) {
            ...
            sendAjaxGet(`/api/User/MtgaDeckDetail?deckId=${mtgaDeckSummary.deckId}&period=${this.modelMtgaDecksPeriod}`, function (statuscode, body) {
                var data = JSON.parse(body);
                if (statuscode === 200) {
                    window.scrollTo(0, 0);
