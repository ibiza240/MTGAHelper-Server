...
namespace MTGAHelper.Lib.OutputLogParser.Models.OutputLogProgress
{
    public class GameProgress
    {
        ...
        public ICollection<CardIdentifier> Library { get; private set; } = Array.Empty<CardIdentifier>();
        public ICollection<CardIdentifier> LibraryOpponent { get; private set; } = Array.Empty<CardIdentifier>();
