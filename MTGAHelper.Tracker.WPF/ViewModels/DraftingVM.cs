...
namespace MTGAHelper.Tracker.WPF.ViewModels
{
    public class DraftInfoBuffered
    {
        ...
        public ICollection<CardDraftPickWpf> CardsDraftBuffered { get; set; } = Array.Empty<CardDraftPickWpf>();
    }
    ...
    public class DraftingVM : BasicModel
    {
        ...
        /// </summary>
        public DraftingVM(IMapper mapper, CardRepositoryProvider repoProvider, ServerApiCaller api, CardThumbnailDownloader cardThumbnailDownloader)
        {
            this.mapper = mapper;
            CardRepoProvider = repoProvider;
            Api = api;
        ...
        public ICollection<CardDraftPickVM> CardsDraft { get; set; } = Array.Empty<CardDraftPickVM>();

        public ICollection<int> CardsThatDidNotWheel { get; set; } = Array.Empty<int>();
        ...
        internal void ResetDraftPicks(string set)
        {
            ...
            CardsDraft = Array.Empty<CardDraftPickVM>();
            CardChosenThatDidNotWheel = default;
            CardsThatDidNotWheel = Array.Empty<int>();
        ...
        internal void SetCardsDraftFromBuffered()
        {
            ...
            lock (LockCardsDraft)
            {
                ...
                var cardsWheeled = CardsThatDidNotWheel
                    .Select(id => cardRepo.GetValueOrDefault(id))
