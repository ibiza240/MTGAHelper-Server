    ...
    public class MapperProfileLibOutputLogParser : Profile
    {
            ...
            )
        {
            ...
            CreateMap<Models.UnityCrossThreadLogger.StartHook.DeckSummary, CourseDeckRaw>()
                ...
                .ForMember(i => i.companionGRPId, o => o.Ignore())
                .ForMember(i => i.commandZoneGRPIds, o => o.Ignore())
                .ForMember(i => i.mainDeck, o => o.Ignore())
                .ForMember(i => i.sideboard, o => o.Ignore())
