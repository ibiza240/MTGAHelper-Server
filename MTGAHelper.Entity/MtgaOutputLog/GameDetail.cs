...
namespace MTGAHelper.Entity.MtgaOutputLog
{
    ...
    public class GameDetail
    {
        ...
        public ICollection<CardTurnAction> CardTransfers { get; set; } = Array.Empty<CardTurnAction>();

        public IReadOnlyList<OutputLogResultGameEvent> ActionLog { get; set; } = Array.Empty<OutputLogResultGameEvent>();
    }
}
