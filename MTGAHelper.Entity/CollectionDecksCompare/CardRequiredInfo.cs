...
namespace MTGAHelper.Entity.CollectionDecksCompare
{
    ...
    {
        public static readonly IReadOnlyDictionary<RarityEnum, UserWeightDto> DEFAULT_WEIGHTS = new Dictionary<RarityEnum, UserWeightDto>
        ...
        public CardRequiredInfo(Card card, bool isForAverageArchetypeOthersInMain, bool isSideboard, IDeck deck, int nbRequired, int nbOwned, int nbMissing, float priorityFactor,
            string userId, IReadOnlyDictionary<RarityEnum, UserWeightDto> weights)
        {
            ...
            var rarity = card.GetRarityEnumSplitRareLands();
